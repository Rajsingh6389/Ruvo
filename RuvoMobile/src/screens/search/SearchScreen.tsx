...
const styles = StyleSheet.create({
  ...
  productName: { fontSize: sf(14), fontFamily: 'Poppins_600SemiBold', marginBottom: sh(4) },
  productCategory: { fontSize: sf(12), marginBottom: sh(6) },
  priceRow: { flexDirection: 'row', alignItems: 'center', gap: sw(6) },
  productPrice: { fontSize: sf(16), fontFamily: 'Poppins_700Bold' },
  ...
  shopInfo: { flex: 1 },
  shopName: { fontSize: sf(16), fontFamily: 'Poppins_600SemiBold', marginBottom: sh(2) },
  ...
  ratingText: { fontSize: sf(12), fontFamily: 'Poppins_600SemiBold' },
  shopAddress: { fontSize: sf(11), flex: 1 },
  noResults: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingTop: sh(80) },
  noResultsText: { fontSize: sf(18), fontFamily: 'Poppins_700Bold', marginTop: sh(16) },
  ...
  suggestionsTitle: { fontSize: sf(18), fontFamily: 'Poppins_700Bold', marginTop: sh(16), marginBottom: sh(12) },
